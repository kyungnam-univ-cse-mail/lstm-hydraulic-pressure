...
# 데이터 로드
hp_data = pd.read_csv('C:/Users/User/Desktop/water/data/weekend_data.csv', usecols=['time', 'JM1_p'], parse_dates=['time'], index_col='time')
...
def lstm_arch(x_train, y_train, x_test, for_periods):
    ...
    lstm_model.fit(x_train, y_train, epochs=700, batch_size=32, verbose=0, shuffle=False)  #batch_size=???
...
lstm_model.save("C:/Users/User/Desktop/water/data/save/weekend/700_32_model.h5")
...
plt.savefig('C:/Users/User/Desktop/water/data/save/weekend/700_32_Jan.jpg')
